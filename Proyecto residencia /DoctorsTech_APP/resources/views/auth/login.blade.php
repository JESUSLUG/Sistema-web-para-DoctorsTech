                  ...
                  <div class="col-lg-6">
                    <div class="card-body p-md-5 mx-md-4">
                      ...
                      <div class="text-center">
                        ...
                        <h4 class="mt-1 mb-5 pb-1">Sistema de cotizaciones DoctorsT Sureste</h4>
                      </div>
                      ...
                      <form action="{{route('login')}}" method="post">
                        ...
                        <div class="text-center pt-1 mb-5 pb-1">
                          ...
                          <button class="btn btn-primary btn-block fa-lg gradient-custom-2 mb-3" style="margin-top: 50px;" onclick="window.location.href= 'menu' ">Ingresar</button>
                        </div>
                  ...
                  <div class="col-lg-6 d-flex align-items-center gradient-custom-2">
                    <div class="text-white px-3 py-4 p-md-5 mx-md-4">
                      ...
                      <p class="small mb-0">Sistema gestor de cotizaciones de DoctorsT S.A de C.V, 
                        realizado por Flavio Abraham Castillo Cruz, el mejor programador que pudo pisar el Tec de Mérida.</p>
                    </div>
                  </div>
                </div>
              </div>
